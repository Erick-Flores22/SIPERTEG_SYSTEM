        ...
        <form action="{{ route('datos_tecnicos.store') }}"
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input type="text" name="plan" id="plan" value="{{ old('plan') }}" required
                     class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            ...
            <div>
              ...
              <input type="text" name="odn" id="odn" value="{{ old('odn') }}" required
                     class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            ...
            <div>
              ...
              <input type="text" name="pon" id="pon" value="{{ old('pon') }}" required
                     class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            ...
            <div>
              ...
              <input type="text" name="codigo_tecnico" id="codigo_tecnico"
                     value="{{ old('codigo_tecnico') }}" required
                     class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            ...
            <div>
              ...
              <input type="text" name="codigo_sistema" id="codigo_sistema"
                     value="{{ old('codigo_sistema') }}" required
                     class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            ...
            <div>
              ...
              <input type="text" name="nodo" id="nodo" value="{{ old('nodo') }}" required
                     class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            ...
            <div>
              ...
              <input type="text" name="caja_distribucion" id="caja_distribucion"
                     value="{{ old('caja_distribucion') }}" required
                     class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            ...
            {{-- Foto Plano --}}
            <div>
              <label for="foto_plano" class="block text-sm font-medium text-gray-700">Foto Plano</label>
